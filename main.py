...
if not MURF_API_KEY:
    print("⚠️  WARNING: MURF_API_KEY not found in .env file. The /generate-audio endpoint will not work.")

# Load and configure your AssemblyAI API key
ASSEMBLYAI_API_KEY = os.getenv("ASSEMBLYAI_API_KEY")
if not ASSEMBLYAI_API_KEY:
    print("⚠️  WARNING: ASSEMBLYAI_API_KEY not found in .env file. The /transcribe endpoint will not work.")
else:
...
if not GEMINI_API_KEY:
    print("⚠️  WARNING: GEMINI_API_KEY not found in .env file. The /llm/query endpoint will not work.")
else:
